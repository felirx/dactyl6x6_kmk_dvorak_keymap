...
keyboard.keymap = [
    [ #QWERTY
        ...
        XXXXXXX,  XXXXXXX,  XXXXXXX,  KC.LALT,  KC.LCTL,  KC.SPC,     KC.BSPC,  LOWEH,    KC.RALT,  KC.MINUS, KC.EQUAL, KC.RCTL,\
                            LOWEH,    XXXXXXX,  RAISE,    KC.LSFT,    KC.RSFT,  XXXXXXX,  KC.DEL,   KC.LGUI,
    ],
    [ #backup dvorak if no sys support
        ...
        XXXXXXX,  XXXXXXX,  XXXXXXX,  KC.LALT,  KC.LCTL,  KC.SPC,     KC.BSPC,  LOWEH,    KC.RALT,  KC.LBRC,  KC.RBRC,  KC.RCTL,\
                            LOWEH,    XXXXXXX,  RAISE,    KC.LSFT,    KC.RSFT,  XXXXXXX,  KC.DEL,   KC.LGUI
     ],
