...
keyboard.keymap = [
    [ #QWERTY
        ...
        XXXXXXX,  XXXXXXX,  XXXXXXX,  KC.LALT,  KC.LCTL,  KC.SPC,     XXXXXXX,  KC.DEL,   KC.RALT,  KC.MINUS, KC.EQUAL, KC.RCTL,\
                            LOWEH,    XXXXXXX,  RAISE,    KC.LSFT,    KC.LGUI,  KC.RSFT,  KC.BSPC,  LOWEH
     ],
    [ #backup dvorak if no sys support
        ...
        XXXXXXX,  XXXXXXX,  XXXXXXX,  KC.LALT,  KC.LCTL,  KC.SPC,     XXXXXXX,  KC.DEL,   KC.RALT,  KC.LBRC,  KC.RBRC,  KC.RCTL,\
                            LOWEH,    XXXXXXX,  RAISE,    KC.LSFT,    KC.LGUI,  KC.RSFT,  KC.BSPC,  LOWEH
     ],
    [ #numpad, mediakeys, arrows, stuff
        ...
        _______,  XXXXXXX,  KC.LEFT,  KC.DOWN,  KC.RGHT,  XXXXXXX,    KC.CAPS,  KC.P4,    KC.P5,    KC.P6,    KC.ENT,  XXXXXXX,\
        _______,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC.V,     XXXXXXX,    LOWER,    KC.P1,    KC.P2,    KC.P3,    KC.PENT,   _______,\
    ...
    [ #symbols that are missink from 6x6 
        ...
        _______,  KC.CAPS,  XXXXXXX,  KC.UP,    XXXXXXX,  KC.PGUP,    TOQWERT,  XXXXXXX,  KC.LCBR , KC.RCBR,  KC.BSLS,  KC.BSLS,\
        _______,  XXXXXXX,  KC.LEFT,  KC.DOWN,  KC.RGHT,  KC.PGDN,    MEDIAS,   XXXXXXX,  KC.LBRC,  KC.RBRC,  KC.PIPE,  KC.PIPE,\
    ...
    [ #mediakeys and memes
        _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  _______,  _______,  _______,  _______,\
        XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  MEDIAS,     KC.N6,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,\
